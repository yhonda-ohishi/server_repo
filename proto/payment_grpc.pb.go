...
const (
	PaymentService_GetPayment_FullMethodName          = "/etc_meisai.v1.PaymentService/GetPayment"
	PaymentService_CreatePayment_FullMethodName       = "/etc_meisai.v1.PaymentService/CreatePayment"
	PaymentService_ListPayments_FullMethodName        = "/etc_meisai.v1.PaymentService/ListPayments"
	PaymentService_GetMonthlyStatement_FullMethodName = "/etc_meisai.v1.PaymentService/GetMonthlyStatement"
)
...
type PaymentServiceClient interface {
	...
	GetMonthlyStatement(ctx context.Context, in *GetMonthlyStatementRequest, opts ...grpc.CallOption) (*MonthlyStatement, error)
}
...
func (c *paymentServiceClient) GetMonthlyStatement(ctx context.Context, in *GetMonthlyStatementRequest, opts ...grpc.CallOption) (*MonthlyStatement, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MonthlyStatement)
	err := c.cc.Invoke(ctx, PaymentService_GetMonthlyStatement_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServiceServer interface {
	...
	// Get monthly statement
	GetMonthlyStatement(context.Context, *GetMonthlyStatementRequest) (*MonthlyStatement, error)
...
func (UnimplementedPaymentServiceServer) GetMonthlyStatement(context.Context, *GetMonthlyStatementRequest) (*MonthlyStatement, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMonthlyStatement not implemented")
}
...
func _PaymentService_GetMonthlyStatement_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMonthlyStatementRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).GetMonthlyStatement(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_GetMonthlyStatement_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetMonthlyStatement(ctx, req.(*GetMonthlyStatementRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "etc_meisai.v1.PaymentService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMonthlyStatement",
			Handler:    _PaymentService_GetMonthlyStatement_Handler,
		},
	},
